...
Berserker::Berserker(const Vector2D& pos)
{
	position = pos;
	timer = 0.0f;
	invincibilityTimeCounter = 0;
	enemyNumber = EnemyNumber::BERSERKER;
...
void Berserker::Attack()
{
	...
	{
		//放物線を描くバレットを生成
		new Bullet(Apos, dis, BulletNumber::BERSERKER, ObjectTag::ENEMY);
