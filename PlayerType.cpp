...
{
	new Slash(pos, SLASH_NUMBER::slash01, lookleft,OBJECT_TAG::PLAYER);
}

void PlayerAttack::Player2MainAttack(const Vector2D& pos,bool lookleft)
{

	new Slash(pos, SLASH_NUMBER::slash02, lookleft, OBJECT_TAG::PLAYER);
}

void PlayerAttack::Player3MainAttack(const Vector2D& pos,bool lookleft)
{
	new Slash(pos, SLASH_NUMBER::slash03,lookleft, OBJECT_TAG::PLAYER);
}
